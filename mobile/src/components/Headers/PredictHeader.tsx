      ...
      >
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            >
              Let us analyze your mango fruit image and assist you with accurate
              disease detection and orchard health insights.
            </Text>
          </View>
          <TouchableOpacity
            hitSlop={30}
          ...
          >
            <Ionicons name="help" size={24} color={COLORS.black} />
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </>
