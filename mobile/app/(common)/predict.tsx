...
import { detectDisease } from "@/src/utils/react-query";
...
const Page = () => {
  ...
  const makePredictions = async () => {
    ...
    if (!!!state.uri) {
      setState((s) => ({
        ...s,
        error: "Please select a Mango Fruit image.",
      }));
      return;
    }
    ...
    const image = generateRNFile({
      name: state.fileName || "mango.jpeg",
      uri: state.uri,
    });
    await mutateAsync({
      image,
      ...
      >
          ...
          <View style={{ flexDirection: "row", flex: 1 }}>
            ...
            >
              <Text style={{ fontFamily: FONTS.bold, fontSize: 25 }}>
                Mango Fruit Image Selection
              </Text>
              <Text style={{ fontFamily: FONTS.regular, color: COLORS.gray }}>
                Select a mango fruit image or capture it live from camera.
              </Text>
            </View>
          </View>
        ...
        >
          <View style={{ flexDirection: "row", flex: 1 }}>
            ...
            >
              <Text style={{ fontFamily: FONTS.bold, fontSize: 25 }}>
                Then, Does my Mango have a Disease?
              </Text>
              <Text style={{ fontFamily: FONTS.regular, color: COLORS.gray }}>
