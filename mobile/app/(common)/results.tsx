  ...
  const plotsData = React.useMemo(() => {
    return hist.prediction.predictions.map(
      ({ label, probability, type }, index) => ({
        ...
        mango: `${type} (${label}) • ${(probability * 100).toFixed(0)}%`,
        label: "",
      })
    );
  }, [hist]);
      ...
      >
        ...
        <Animated.View entering={SlideInLeft.duration(200).delay(200)}>
          <Card style={[styles.card]}>
            ...
            >
              Based on the provided images, here are the mango insights.
            </Text>
        ...
        <Animated.View entering={SlideInRight.duration(200).delay(200)}>
          <Card style={[styles.card]}>
            ...
            >
              {hist.prediction.top_prediction.type === "Healthy"
                ? "Based on the mango image the mango is health"
                : `Based on the mango image the mango has '${hist.prediction.top_prediction.type}'.`}
            </Text>
        ...
        >
          <View>
            ...
            >
              Want to try another Mango Fruit Image?
            </Text>
            <Text
              style={{
                fontFamily: FONTS.regular,
            ...
            >
              Change the mango fruit image or try to take another clear image
              and see the results.
            </Text>
          </View>
          <Button
            title={`Scan a Mango Fruit Again`}
            Icon={
