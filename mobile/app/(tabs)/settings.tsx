      ...
      >
        ...
        <SettingItem
          onPress={async () => {
            ...
            Alert.alert(
              APP_NAME,
              "Are you sure you want to reset Mango Watch?",
              [
                {
                  text: "YES",
                  style: "default",
      ...
      >
        <SettingItem
          onPress={async () => {
            ...
            await Share.share(
              {
                url: "https://github.com/CrispenGari/MangoWatch",
                message:
                  "An AI-powered mobile tool that assists in the detection of mango diseases from fruit images, supporting early diagnosis and better orchard management: Download at https://github.com/CrispenGari/MangoWatch",
                title: "Share  Mango Watch with a Friend",
              },
              { dialogTitle: "Share Mango Watch", tintColor: COLORS.tertiary }
            );
          }}
          title="Share Mango Watch"
          Icon={
        ...
        <SettingItem
          ...
          title="How does Mango Watch works"
        ...
        <SettingItem
          onPress={async () => {
            ...
            const res = await Linking.canOpenURL(
              "https://github.com/CrispenGari/MangoWatch/issues"
            );
            if (res) {
              Linking.openURL(
                "https://github.com/CrispenGari/MangoWatch/issues"
